 ...
 <section id="home" class="banner-area banner-bg fix">
                <div class="container">
                    <div class="row align-items-center">
                        <?php
                            $banner_part_query = "SELECT * FROM banners WHERE status = 1";
                            $banner_q = mysqli_query($db_connect, $banner_part_query);
                            $banner_info = mysqli_fetch_assoc($banner_q);
                        ?>
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s"><?=$banner_info['banner_subtitle']?></h6>
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s"><?=$banner_info['banner_title']?></h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s"><?=$banner_info['banner_description']?></p>
                        ...
                        <?php
                            $banner_img_query = "SELECT * FROM banner_images WHERE status = 1";
                            $banner_img = mysqli_query($db_connect, $banner_img_query);
                            $banner_img = mysqli_fetch_assoc($banner_img);
                        ?>
                        <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                            <div class="banner-img text-right">
                                <!-- <img src="assets/frontend/img/banner/banner_img.png" alt=""> -->
                                <img src="backend/uploads/banner_image/<?=$banner_img['banner_image']?>" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 pr-90">
                            ...
                            <?php 
                            $edu_data_view_quary = "SELECT * FROM educations WHERE status = 'active'";
                            $edu_data_q = mysqli_query($db_connect,$edu_data_view_quary);
                        ?>
                        <?php 
                        foreach ($edu_data_q as $edu) {
                        ?>
                            <!-- Education Item -->
                            <div class="education">
                                <div class="year"><?= $edu['edu_year']?></div>
                                <div class="line"></div>
                                <div class="location">
                                    <span><?= $edu['edu_title']?></span>
                                    <div class="progressWrapper">
                                        <div class="progress">
                                            <div class="progress-bar wow slideInLefts" data-wow-delay="0.2s" data-wow-duration="2s" role="progressbar" style="width: <?= $edu['edu_percentage']?>%;" aria-valuenow="65" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <section id="service" class="services-area pt-120 pb-50">
				<div class="container">
					...
					<div class="row">
                        <?php 
                            $service_data_view_quary = "SELECT * FROM services WHERE status = 'active'";
                            $service_data_q = mysqli_query($db_connect,$service_data_view_quary);
                        ?>
                        <?php 
                        foreach ($service_data_q as $services) {
            ...
            <section id="portfolio" class="portfolio-area primary-bg pt-120 pb-90">
                <div class="container">
                    ...
                    <div class="row">
                        <?php 
                            $work_view_quary = "SELECT * FROM works WHERE status = 'Active'";
                            $work_data_q = mysqli_query($db_connect, $work_view_quary);
                            foreach ($work_data_q as $works) {
                        ?>
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
								<div class="speaker-thumb">
									<img src="backend/uploads/works/<?= $works['work_img']?>" alt="img" height="500">
								</div>
								<div class="speaker-overlay">
									<span><?= $works['work_category']?></span>
									<h4><a href="portfolio-single.html"><?= $works['work_title']?></a></h4>
                ...
                <div class="container">
                    <div class="fact-wrap">
                        <div class="row justify-content-between">
                            <?php
                            $fact_select_query = "SELECT * FROM facts WHERE status = 'active'";
                            $fact_query = mysqli_query($db_connect, $fact_select_query);
                            foreach ($fact_query as $facts) {
                            ?>
                            <div class="col-xl-2 col-lg-3 col-sm-6">
                                <div class="fact-box text-center mb-50">
                                    <div class="fact-icon">
                                        <i class="<?= $facts['fact_icon']?>"></i>
                                    </div>
                                    <div class="fact-content">
                                        <h2><span class="count"><?= $facts['fact_count']?></span></h2>
                                        <span><?= $facts['fact_title']?></span>
                                    </div>
                                </div>
                            </div>
                            <?php
                    ...
                    <div class="row brand-active">
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="assets/frontend/img/brand/brand_img01.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="assets/frontend/img/brand/brand_img02.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="assets/frontend/img/brand/brand_img03.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="assets/frontend/img/brand/brand_img04.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
                                <img src="assets/frontend/img/brand/brand_img05.png" alt="img">
                            </div>
                        </div>
                        <div class="col-xl-2">
                            <div class="single-brand">
