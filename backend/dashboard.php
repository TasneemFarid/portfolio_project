                        ...
                        <div class="col-xl-6">
                                <div class="card widget widget-list">
                                    <div class="card-header">
                                        <?php
                                        $user_count_query = "SELECT COUNT(*) AS entry FROM users";
                                        $user_count = mysqli_query($db_connect, $user_count_query);
                                        $after_user_count_assoc = mysqli_fetch_assoc($user_count);
                                        ?>
                                        <h5 class="card-title">New Users<span class="badge badge-success badge-style-light"><?= $after_user_count_assoc['entry'] ?> total</span></h5>
                                    </div>
                                    <div class="card-body">
                                        <span class="text-muted m-b-xs d-block">Showing 5 out of
                                            <?= $after_user_count_assoc['entry'] ?> new users.</span>
                                            ...
                                            <li class="widget-list-item widget-list-item-red">
                                                <span class="widget-list-item-avatar">
                                                    <div class="avatar avatar-rounded">
                                                        <div class="avatar-title"> <?= $users['id']; ?></div>
                                                    </div>
                                                </span>
